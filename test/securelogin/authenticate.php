...
require('config.php');
// Default
if ( !isset($loginattempts_username) ) $loginattempts_username='';
if ( !isset($loginattempts_total) )    $loginattempts_total=0;
...
$result1 = mysql_query("SELECT `loginattempt` FROM `users` WHERE `username`='$user'");
